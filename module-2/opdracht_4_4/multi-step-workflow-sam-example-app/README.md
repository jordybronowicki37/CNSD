...
```bash
multi-step-workflow-sam-example-app$ sam build --use-container
```
...
```bash
multi-step-workflow-sam-example-app$ sam logs -n StockCheckerFunction --stack-name "multi-step-workflow-sam-example-app" --tail
```
...
```bash
multi-step-workflow-sam-example-app$ pip install -r tests/requirements.txt --user
# unit test
multi-step-workflow-sam-example-app$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
multi-step-workflow-sam-example-app$ AWS_SAM_STACK_NAME="multi-step-workflow-sam-example-app" python -m pytest tests/integration -v
```
...
```bash
sam delete --stack-name "multi-step-workflow-sam-example-app"
```
